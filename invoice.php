...
<!DOCTYPE html>
 ...
 <body>
  <div id="wrapshopcart">
   ...
   <label>Nama Lengkap : <?php echo $post['nama_depan'] . ' ' . $post['nama_belakang'] ;?> </label>
 
   <label>Email : <?php echo $post['email'] ;?> </label>
 
   <label>No HP : <?php echo $post['no_hp'] ;?></label>
 
   <label>No Telp : <?php echo $post['no_telp'] ;?></label>
 
   <label>Alamat : <?php echo $post['alamat'] ;?></label>
